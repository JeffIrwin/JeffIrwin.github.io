...
<!-- Tab link buttons -->
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'syntran_0')" id="default_open_0">syntran</button>
...
<!-- Tab link buttons -->
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'syntran_1')" id="default_open_1">syntran</button>
  <button class="tablinks" onclick="openTab(event, 'c_1')">C</button>
</div>

<!-- Tab content -->
<div id="syntran_1" class="tabcontent">
{% highlight rust %}
fn main(): i32
{
