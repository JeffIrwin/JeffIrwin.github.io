...
<!--
TODO: go live
- link from top-level "posts" page
- cross post to socials
- ffmpeg is slowly becoming one of my favorite tools.  i wrote up my journey through what seemed like a common problem that yielded no stackoverflow results
-->
...
find on [stack](https://stackoverflow.com/q/53795205/4347028)
[overflow](https://stackoverflow.com/q/53795205/4347028)
...
one-liners.  To start, the first two steps of cropping an blurring can be
combined:
